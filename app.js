...
(function () {
  ...
  var css = [
    ...
    '.ptxt img,.ptxt-html img{max-width:min(280px,82%);max-height:340px;width:auto;height:auto;object-fit:contain;border-radius:12px;display:block;margin:10px 0;cursor:pointer;}',
    /* 删除/编辑键始终可见可点 */
